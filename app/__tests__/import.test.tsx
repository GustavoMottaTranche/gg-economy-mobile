  ...
  useTranslation: () => ({
    t: (key: string, params?: Record<string, unknown>) => {
      const translations: Record<string, string> = {
        'fileImport.title': 'Import',
        'fileImport.selectFile': 'Select File',
        'fileImport.importing': 'Importing...',
        'fileImport.success': 'Import completed',
        'fileImport.error': 'Import error',
        'fileImport.supportedFormats': 'Supported formats: CSV, OFX, QIF',
        'fileImport.fileSelected': 'File selected',
        'fileImport.parsing': 'Parsing file...',
        'fileImport.processing': 'Processing transactions...',
        'fileImport.checkingDuplicates': 'Checking for duplicates...',
        'fileImport.transactionsFound': `${params?.count ?? 0} transaction(s) found`,
        'fileImport.duplicatesFound': `${params?.count ?? 0} possible duplicate(s)`,
        'fileImport.importComplete': 'Import completed successfully',
        'fileImport.importFailed': 'Import failed',
        'fileImport.invalidFormat': 'Invalid file format',
        'fileImport.noTransactionsFound': 'No transactions found in file',
        'fileImport.parseError': 'Error parsing file',
        'fileImport.goToReview': 'Go to review',
        'common.close': 'Close',
