// Migration to add is_paid column to weekly_occurrences and transactions tables.
// Enables tracking payment status for recurring expense occurrences.
// Requirements: 1.1, 1.6, 1.7

const sql = `ALTER TABLE \`weekly_occurrences\` ADD COLUMN \`is_paid\` INTEGER NOT NULL DEFAULT 0;
