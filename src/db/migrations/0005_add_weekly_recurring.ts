// Migration to create weekly_recurring_groups and weekly_occurrences tables.
// weekly_recurring_groups stores the definition of weekly recurring expenses.
// weekly_occurrences stores individual generated occurrences for each week.
// Requirements: 1.1, 6.1

const sql = `CREATE TABLE IF NOT EXISTS \`weekly_recurring_groups\` (
